						...
						<View className='bg-[#FFFEFE] py-1 px-6 mx-3 mt-9  rounded-3xl  h-[32vh] flex flex-col justify-between'>
							<View className='h-1/3 flex flex-row justify-between py-5'>
								<View className='h-max flex flex-col justify-between'>
									<Text style={{ fontFamily: 'Satoshi'}} className='text-[13px] text-[#727B86]'>Beneficiary</Text>
									<Text style={{ fontFamily: 'Satoshi'}} className='text-[13px] font-bold text-[#4879E7]'>Dolly Sheep</Text>
								</View>
							...
							<View className='h-1/3 flex flex-row justify-between py-5'>
								<View className='h-max flex flex-col justify-between'>
									<Text style={{ fontFamily: 'Satoshi'}} className='text-[13px] text-[#727B86]'>IBAN</Text>
									<Text style={{ fontFamily: 'Satoshi'}} className='text-[13px] font-bold text-[#4879E7]'>GB35 FLEX 0039 7063 4597 17</Text>
								</View>
								<View className='flex flex-col justify-center'>
									<MaterialCommunityIcons className='' name='content-copy' size={17} color="#4879E7"/>
								</View>
