		...
		<View className='h-full bg-[#F9F8F9] flex-1 mt-4' >
			<SafeAreaView>
				...
				<View className='top-0 flex flex-col pt-1 px-4'>
					...
					<Text className="text-black text-[32px] font-bold" style={{ fontFamily: 'GeneralSans'}} >Collectibles</Text>
				...
				{
					!hide &&
					<LinearGradient colors={['#4c669f', '#3b5998', '#192f6a']} className='h-[360px] bg-gradient-to-b	from-sky-500 to-indigo-500 rounded-2xl flex flex-col mx-4 mt-8'>
						...
						<View className='h-1/2 flex flex-col px-6 justify-between pb-[16px] '>
							<View>
								<View className='mt-2'>
									<Text className='text-[30px] font-bold text-white' style={{ fontFamily: 'Satoshi'}}>Keep your Digital Collections</Text>
								</View>
							</View>
							<View className='flex flex-row pr-[80px] space-x-4 items-center'>
								<View className='mr-8'>
									<Text className='text-[13px] font-light text-white'>Store and use your digital collectables safely and with full custody</Text>
								</View>
